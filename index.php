      ...
      <div class="container-fluid">
        <div class="row">
          <div class="offset-md-1 col">
            <h2>Ireland's leading full-service digital agency</h2>
          </div>
        </div>
        <div class="row">
          <div class="col-xs-12 col-sm-4 offset-md-1 col-md padding-b">
          ...
          <div class="col-xs-12 col-sm-4 col-md padding-b">
            <h3><a href="./web-development.php">Development</a></h3>
            ...
            <p><a href="./web-development.php" class="icon forward">Find out more</a></p>
          </div>
          <div class="col-xs-12 col-sm-4 col-md padding-b">
            <h3><a href="./digital-marketing.php">Marketing</a></h3>
            <p>As one of Ireland's leading Digital Marketing Agencies, we execute and measure your digital strategy to create a successful online presence.</p>
