    ...
    <main>
        <div class="slider-wrapper">
            ...
            <div class="home-slider">
                <div class="item work"><a href="./portfolio.php">Work</a>
                </div>
                <div class="item services"><a href="./what-we-do.php">Services</a>
                </div>
                <div class="item about"><a href="./who-we-are.php">About</a>
                </div>
                <div class="item careers"><a href="./careers.php">Careers</a>
                </div>
            </div>
        </div>
    </main>
